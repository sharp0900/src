...
public class Game extends Form implements Runnable {
	...
	public Game() {
		...
		addSpaceShip
				.setIcon(FontImage.createMaterial(FontImage.MATERIAL_NAVIGATION, addSpaceShip.getUnselectedStyle()));
		...
		addAsteroidButton.setIcon(
				FontImage.createMaterial(FontImage.MATERIAL_PANORAMA_FISH_EYE, addSpaceShip.getUnselectedStyle()));
		...
		addNonPlayerShip
				.setIcon(FontImage.createMaterial(FontImage.MATERIAL_NEAR_ME, addSpaceShip.getUnselectedStyle()));
		...
		jump.setIcon(FontImage.createMaterial(FontImage.MATERIAL_TRANSFER_WITHIN_A_STATION,
				addSpaceShip.getUnselectedStyle()));
		...
		refill.setIcon(
				FontImage.createMaterial(FontImage.MATERIAL_BATTERY_CHARGING_FULL, addSpaceShip.getUnselectedStyle()));
		...
		station.setIcon(
				FontImage.createMaterial(FontImage.MATERIAL_PANORAMA_WIDE_ANGLE, addSpaceShip.getUnselectedStyle()));
		...
		play.setIcon(
				FontImage.createMaterial(FontImage.MATERIAL_PLAY_CIRCLE_OUTLINE, addSpaceShip.getUnselectedStyle()));
		...
		pause.setIcon(
				FontImage.createMaterial(FontImage.MATERIAL_PAUSE_CIRCLE_OUTLINE, addSpaceShip.getUnselectedStyle()));
		...
		exit.setIcon(FontImage.createMaterial(FontImage.MATERIAL_EXIT_TO_APP, addSpaceShip.getUnselectedStyle()));
